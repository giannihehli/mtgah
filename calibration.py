...
# Input used camera
camera = 'gopro1' # 'sony' or 'gopro1' or 'gopro2'

# Input images capturing the chessboard above
match camera:
    case 'sony':
        input_files = 'H:/data/calibration/sony/*.jpg'
        output = 'H:/data/calibration/sony/result.pdf'
    case 'gopro1':
        input_files = 'H:/data/calibration/gopro1/*.jpg'
        output = 'H:/data/calibration/gopro1/result.pdf'
    case 'gopro2':
        input_files = 'H:/data/calibration/gopro2/*.jpg'
        output = 'H:/data/calibration/gopro2/result.pdf'
