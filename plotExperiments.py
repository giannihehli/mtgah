...
def plottotal(data_path, df_tot):
    ...
    for i, roughness in enumerate(unique_roughness):
        ...
        axis[i//2, i%2].legend(loc='lower right')
    ...
    # Create the legends
    legend1 = axis[1, 1].legend(handles=handles1, labels=labels1, loc='lower right')
    legend2 = axis[1, 1].legend(handles=handles2, labels=labels2, loc='lower left')
